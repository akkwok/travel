...
function callPlayer(e,a){var t=0,r=document.getElementsByTagName("iframe"),i="";for(t=0;t<r.length;t+=1)(i=r[t].getAttribute("src"))&&-1!==i.indexOf("youtube.com/embed")&&r[t].contentWindow.postMessage(JSON.stringify({event:"command",func:e,args:a||[]}),"*")}$(function(){function e(){ScrollTrigger.sort(),ScrollTrigger.refresh()}function a(){r.removeClass("hd-active").attr("aria-current","false"),$(".trigger-video").attr("aria-expanded","false"),callPlayer("pauseVideo"),$("body").css("overflow",""),""!=o&&(o.focus(),o="")}function t(e,a,t){window.dataLayer=window.dataLayer||[],window.dataLayer.push({event:"data_layer_event",event_category_DL:e,event_action_DL:a,event_label_DL:t})}gsap.registerPlugin(ScrollTrigger),gsap.registerPlugin(ScrollToPlugin),gsap.defaults({overwrite:"auto",duration:.4}),$(window).on("resize",function(){setTimeout(function(){e()},400)}),$("#product_gallery").length>0&&new ResizeObserver(e).observe(document.querySelector("#product_gallery")),$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=$(this.hash);if((e=e.length?e:$("[name="+this.hash.slice(1)+"]")).length)return $("html, body").stop(0,1).animate({scrollTop:e.offset().top},800),!1}}),function(e){e.off("keydown").on("keydown",function(e){var a=e.keyCode?e.keyCode:e.which;"13"!=a&&"32"!=a||(("32"==a||$(this).is("button"))&&e.preventDefault(),$(this).trigger("click"))})}($('#hd :not(button)[role="button"], #hd li[tabindex="0"], #hd div[tabindex="0"]')),window.sr=ScrollReveal({reset:!1,mobile:!0,duration:600,origin:"bottom",distance:"30px",opacity:0,scale:1,viewFactor:.25,easing:"ease-out"}),sr.reveal("#hd .reveal",{distance:0}),sr.reveal("#hd .reveal-delay1",{distance:0,delay:150}),sr.reveal("#hd .reveal-delay2",{distance:0,delay:300}),sr.reveal("#hd .reveal-delay3",{distance:0,delay:400}),sr.reveal("#hd .reveal-delay4",{distance:0,delay:600}),sr.reveal("#hd .reveal-top",{origin:"top",distance:"12%",duration:1200,easing:"ease-in-out"}),sr.reveal("#hd .reveal-top-delay1",{origin:"top",distance:"12%",duration:1200,easing:"ease-in-out",delay:400}),sr.reveal("#hd .reveal-bottom",{}),sr.reveal("#hd .reveal-bottom-delay1",{delay:150}),sr.reveal("#hd .reveal-bottom-delay2",{delay:300}),sr.reveal("#hd .reveal-bottom-delay3",{delay:400}),sr.reveal("#hd .reveal-left",{origin:"left",delay:0}),sr.reveal("#hd .reveal-left-delay1",{origin:"left",delay:150}),sr.reveal("#hd .reveal-list-1",150),sr.reveal("#hd .reveal-list-2",150),sr.reveal("#hd .reveal-list-3",150),sr.reveal("#hd .reveal-list-4",150),sr.reveal("#hd .reveal-list-5",150),sr.reveal("#hd .reveal-list-6",150),sr.reveal("#hd .reveal-list-7",150);window.matchMedia("(max-width: 620px)").matches&&sr.reveal("#hd .reveal-list-mobile",{},150),sr.reveal("#hd .reveal-animate",{reset:!1,duration:100,opacity:1,distance:0,scale:0,easing:"ease-out",beforeReveal:function(e){$(e).addClass("is-animated")},beforeReset:function(e){$(e).removeClass("is-animated")}}),sr.reveal("#hd .reveal-animate-reset",{reset:!0,duration:100,opacity:1,distance:0,scale:0,easing:"ease-out",beforeReveal:function(e){$(e).addClass("is-animated")},beforeReset:function(e){$(e).removeClass("is-animated")}}),sr.reveal("video.reveal-video",{reset:!0,duration:0,opacity:1,distance:0,scale:0,easing:"none",viewFactor:.4,delay:800,beforeReveal:function(e){$(e).trigger("play"),$(e).parents(".trigger-video-toggle").find(".vid-control").removeClass("hd-active").attr("aria-pressed","false")},beforeReset:function(e){$(e).trigger("pause"),$(e).parents(".trigger-video-toggle").find(".vid-control").addClass("hd-active").attr("aria-pressed","true")}}),$(".gif-container .vid-control").on("click",function(){var e=$(this);e.toggleClass("hd-active"),e.hasClass("hd-active")?e.attr("aria-pressed","true"):e.attr("aria-pressed","false"),e.parents(".hd-container").find(".gif-container").toggleClass("is-reduced-motion")}),$(".control-ani").on("click",function(){var e=$(this),a=$("#"+e.attr("aria-controls"));e.toggleClass("hd-active"),e.hasClass("hd-active")?e.attr("aria-pressed","true"):e.attr("aria-pressed","false"),a.toggleClass("is-reduced-motion")}),$(".trigger-video-toggle .vid-control").on("click",function(){var e=$(this),a=e.parents(".trigger-video-toggle").find("video");a[0].paused?(a.each(function(){this.play()}),e.removeClass("hd-active")):(a.each(function(){this.pause()}),e.addClass("hd-active")),e.hasClass("hd-active")?e.attr("aria-pressed","true"):e.attr("aria-pressed","false")}),$("#pageContent-sec-connectivity .list-port li").on("mouseenter focus",function(){var e=$("#"+$(this).attr("aria-controls"));$(this).attr("aria-current","true").siblings().attr("aria-current","false"),e.attr("aria-current","true").siblings().attr("aria-current","false")}),$("#pageContent-sec-control .list-feature li").on("click",function(){$(this).attr("aria-controls").split(",").forEach(function(e){e=e.replace(/\s/g,"");$("#"+e).attr("aria-current","true").siblings().attr("aria-current","false")}),$(this).attr("aria-expanded","true").siblings().attr("aria-expanded","false")});const r=$("#pageContent-lightbox"),i=r.find("iframe");let o="";$(".trigger-video").on("click",function(){let e=$(this);e.data("type");e.attr("aria-expanded","true"),r.removeClass("type-img");let a=e.data("src")+"?modestbranding=0&color=white&mute=1&autoplay=0";i.attr("src",a),i.attr("src",a.replace("autoplay=0","autoplay=1")),callPlayer("playVideo"),r.addClass("hd-active").attr("aria-current","true"),r.focus(),o=e}),$("#pageContent-lightbox .hd-filter, #pageContent-lightbox .trigger-close").on("click",function(){a()}),$(document).on("keydown",function(e){27==e.which&&a()});var n="",s="",l="";window.dataLayer=window.dataLayer||[],$("#hd").on("click",'[data-action="clicked"], [data-action="downloaded"]',function(){var e=$(this);n=e.data("category"),s=e.data("action"),l=e.data("label"),t(n,s,l)}),$("#hd").on("mouseenter",'[data-action="hovered"]',function(){var e=$(this);n=e.data("category"),s=e.data("action"),l=e.data("label"),t(n,s,l)})});

$(function(){let a=$("#pageContent-sec-award .hd-logo"),o=$("#pageContent-sec-award .hd-logo svg path"),t=($("#pageContent-sec-award .hd-container"),gsap.timeline({scrollTrigger:{trigger:"#pageContent-sec-award .hd-scroller",start:"top center",end:"bottom bottom",scrub:1}}));ScrollTrigger.matchMedia({"(min-width: 1281px)":function(){t.clear(),t.fromTo(o,{strokeDashoffset:1260},{strokeDashoffset:0,duration:2},"award-path").fromTo(a,{autoAlpha:1},{autoAlpha:0,duration:1.5,delay:1.7},"award-pos").fromTo(a,{scale:8.5,xPercent:-500,y:"-65vw"},{scale:1.25,xPercent:0,y:0,duration:3},"award-pos")},"(min-width: 1024px) and (max-width: 1280px)":function(){t.clear(),t.fromTo(o,{strokeDashoffset:1260},{strokeDashoffset:0,duration:2},"award-path").fromTo(a,{autoAlpha:1},{autoAlpha:0,duration:1.5,delay:1.7},"award-pos").fromTo(a,{scale:6,xPercent:-500,y:"-65vw"},{scale:1.25,xPercent:0,y:0,duration:3},"award-pos")},"(max-width: 1023px)":function(){t.clear(),t.fromTo(o,{strokeDashoffset:1260},{strokeDashoffset:0,duration:2},"award-path").fromTo(a,{autoAlpha:1},{autoAlpha:0,duration:1.5,delay:1.7},"award-pos").fromTo(a,{scale:9,xPercent:0,y:"-90vw"},{scale:1.25,xPercent:0,y:0,duration:3},"award-pos")},"(max-width: 480px)":function(){t.clear(),t.fromTo(o,{strokeDashoffset:1260},{strokeDashoffset:0,duration:2},"award-path").fromTo(a,{autoAlpha:1},{autoAlpha:0,duration:1.5,delay:1.7},"award-pos").fromTo(a,{scale:15,xPercent:50,y:"-130vw"},{scale:1.25,xPercent:0,y:0,duration:3},"award-pos")}})});

$(function(){let e=$("#pageContent-sec-wifi7 .hd-slogan");gsap.timeline({scrollTrigger:{trigger:"#pageContent-sec-wifi7 .hd-scroller",endTrigger:"#pageContent-sec-wifi7",start:"top center",end:"bottom bottom",scrub:1}}).fromTo(e,{backgroundSize:"50%"},{backgroundSize:"300%",duration:3},"wifi7-slogan")});

$(function(){let a;ScrollTrigger.matchMedia({"(min-width: 1024px)":function(){(a=gsap.timeline({scrollTrigger:{trigger:"#pageContent-sec-performance .hd-pin",pin:"#pageContent-sec-performance .hd-pin",start:"top top+=100",end:"+=200%",scrub:.5,toggleActions:"play none none reverse"}})).clear(),a.from("#hd .panel-coverage .txt-coverage > *",{autoAlpha:0,y:40,stagger:.15},"antenna-in").from("#hd .panel-coverage .part-1-pd",{autoAlpha:0,x:5},"antenna-in").from("#hd .panel-coverage .part-1-highlight",{autoAlpha:0},"antenna-in+=.4").from("#hd .panel-coverage .line-1",{autoAlpha:0,x:20},"antenna-in+=.4").from("#hd .panel-coverage .hd-txt-1",{autoAlpha:0,x:20},"antenna-in+=.6").to({},{duration:.25}).from("#hd .panel-coverage .part-2-pd",{autoAlpha:0,x:20},"heatsink-in").from("#hd .panel-coverage .part-2-highlight",{autoAlpha:0},"heatsink-in+=.4").from("#hd .panel-coverage .line-2",{autoAlpha:0,x:20},"heatsink-in+=.4").from("#hd .panel-coverage .hd-txt-2",{autoAlpha:0,x:20},"heatsink-in+=.6")},"(max-width: 1023px)":function(){(a=gsap.timeline({scrollTrigger:{trigger:"#pageContent-sec-performance .panel-coverage",pin:"#pageContent-sec-performance .panel-coverage",start:"top top+=60",end:"+=200%",scrub:.5}})).clear(),a.from("#hd .panel-coverage .txt-coverage > *",{autoAlpha:0,y:40,stagger:.15},"antenna-in").from("#hd .panel-coverage .part-1-pd",{autoAlpha:0,x:5},"antenna-in").from("#hd .panel-coverage .part-1-highlight",{autoAlpha:0},"antenna-in+=.4").from("#hd .panel-coverage .line-1",{autoAlpha:0,x:20},"antenna-in+=.4").from("#hd .panel-coverage .hd-txt-1",{autoAlpha:0,x:20},"antenna-in+=.6").to({},{duration:.25}).from("#hd .panel-coverage .part-2-pd",{autoAlpha:0,x:20},"heatsink-in").from("#hd .panel-coverage .part-2-highlight",{autoAlpha:0},"heatsink-in+=.4").from("#hd .panel-coverage .line-2",{autoAlpha:0,x:20},"heatsink-in+=.4").from("#hd .panel-coverage .hd-txt-2",{autoAlpha:0,x:20},"heatsink-in+=.6")}})});

$(function(){gsap.timeline({scrollTrigger:{trigger:"#pageContent-sec-setup",pin:"#pageContent-sec-setup .hd-scroller",pinSpacing:!0,start:"top top+=50",end:"+=80%",scrub:.1,toggleActions:"play complete none reverse"}}).from("#pageContent-sec-setup .hd-scroller .slogan-free",{xPercent:150,autoAlpha:0},"step-in").from("#pageContent-sec-setup .hd-p-container",{yPercent:30,autoAlpha:0},"step-in+=.2")});

$(function(){function e(e){n.attr("aria-current","false"),n.eq(e).attr("aria-current","true")}function t(e,t){let n=e.scrollTrigger;return n.start+(n.end-n.start)*(e.labels[t]/e.duration())}let n=$("#pageContent-sec-security .hd-indicator-container li"),a=gsap.timeline({scrollTrigger:{trigger:"#pageContent-sec-security .hd-pin",pin:"#pageContent-sec-security .hd-pin",pinSpacing:!1,start:"top top+=100",end:"bottom bottom",scrub:.1,toggleActions:"play none none reverse",onUpdate:function(){e(a.progress()<.47?0:a.progress()<.75?1:2)}}});a.fromTo("#pageContent-sec-security .hd-indicator-container",{autoAlpha:0},{autoAlpha:1}).fromTo("#pageContent-sec-security .hd-panel:nth-child(1)",{autoAlpha:0},{autoAlpha:1},"panel-1").from("#pageContent-sec-security .hd-panel:nth-child(1) .hd-content > *",{yPercent:30,autoAlpha:0,stagger:.15},"panel-1+=.5").addLabel("panel-1-end").to("#pageContent-sec-security .hd-panel:nth-child(1)",{autoAlpha:0},"panel-2").fromTo("#pageContent-sec-security .hd-panel:nth-child(2)",{autoAlpha:0},{autoAlpha:1},"panel-2").from("#pageContent-sec-security .hd-panel:nth-child(2) .hd-content > *",{yPercent:30,autoAlpha:0,stagger:.15},"panel-2+=.5").addLabel("panel-2-end").to("#pageContent-sec-security .hd-panel:nth-child(2)",{autoAlpha:0},"panel-3").fromTo("#pageContent-sec-security .hd-panel:nth-child(3)",{autoAlpha:0},{autoAlpha:1},"panel-3").from("#pageContent-sec-security .hd-panel:nth-child(3) .hd-content > *",{yPercent:30,autoAlpha:0,stagger:.15},"panel-3+=.5").addLabel("panel-3-end"),n.on("click",function(){let n=$(this).index();switch(e(n),n){case 0:gsap.to(window,{scrollTo:t(a,"panel-1-end"),duration:1});break;case 1:gsap.to(window,{scrollTo:t(a,"panel-2-end"),duration:1});break;case 2:gsap.to(window,{scrollTo:t(a,"panel-3-end"),duration:1})}})});
